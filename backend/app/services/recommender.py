...
def recommend_path(graph: KnowledgeGraph, mastered_node_ids: list[str]) -> LearningPathResult:
    ...
    return LearningPathResult(recommendations=items[:6], path_edges=used_path_edges)
